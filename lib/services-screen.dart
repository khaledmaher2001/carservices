              ...
              body: Padding(
                ...
                child: Column(
                  children: [
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            ...
                                            child: Align(
                                              ...
                                              child: Image.asset(choices[index].icon,
                    ...
                    state is CreateOrderLoadingState? Center(child: CircularProgressIndicator()):ElevatedButton(
                        onPressed: () async{
                          if(choicesServices.isEmpty){
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Not Services Selected"),backgroundColor: Colors.red,),);
                          }else{
                            await AppCubit.get(context).createOrder(context, services: choicesServices);
